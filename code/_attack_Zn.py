...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_1p0 = RealNumber('1.0'); _sage_const_4 = Integer(4); _sage_const_31 = Integer(31); _sage_const_3 = Integer(3)
...
def generate_U_DvW(n, sigma, B=None):
    ...
    if B is None:
        ...
        if abs(B.determinant()) != _sage_const_1 :
...
def one_experiment_structured(params):
    ...
    if randomise:
        V = generate_U_DvW(_sage_const_2  * deg, sigma, B=B)
        assert abs(V.determinant()) == _sage_const_1 
        Q = V * Q * V.transpose()
